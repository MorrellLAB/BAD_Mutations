...
class SetupEnv:
    ...
    def set_user_vars(self, base, target, evalue, 
    ...
    def get_exe_paths(self):
        ...
        if self.bash_path == '':
            self.mainlog.warning('Cannot find bash! Setting to empty path.')
        if self.gzip_path == '':
            self.mainlog.warning('Cannot find gzip! Setting to empty path.')
        if self.sum_path == '':
            self.mainlog.warning('Cannot find sum! Setting to empty path.')
        if self.tblastx_path == '':
            self.mainlog.warning('Cannot find tblastx! Setting to empty path.')
        if self.prank_path == '':
            self.mainlog.warning('Cannot find prank! Setting to empty path.')
        if self.hyphy_path == '':
            self.mainlog.warning('Cannot find HYPHYSP! Setting to empty path.')
        return
