...
class SetupEnv(object):
    ...
    def get_deps(self):
        ...
        if 'HyPhy' in self.missing_progs:
            self.hyphy_path = self.deps + '/hyphy-master/'
        return
    ...
    def write_config(self):
        ...
        BAD_Mutations_Config.set(dependency_section, "BASH", self.bash_path)
        BAD_Mutations_Config.set(dependency_section, "GZIP", self.gzip_path)
        BAD_Mutations_Config.set(dependency_section, "SUM", self.sum_path)
        BAD_Mutations_Config.set(dependency_section, "TBlastX", self.tblastx_path)
        BAD_Mutations_Config.set(dependency_section, "HyPhy", self.hyphy_path)
        blast_section = "BLAST_Settings"
        BAD_Mutations_Config.set(blast_section, "Base", self.base)
        BAD_Mutations_Config.set(blast_section, "Target", self.target_species)
        BAD_Mutations_Config.set(blast_section, "Evalue", self.eval_thresh)
        BAD_Mutations_Config.set(blast_section, "Missing", self.miss_thresh)
