...
\end{Verbatim}
\par You will have to install \texttt{requests} and \texttt{PASTA} as their
user manuals instruct.
...
\begin{table}[H]
    ...
    \texttt{-e/--evalue}* & [FLOAT] & E-value threshold for accepting TBLASTX hits as putative orthologues. Defaults to 0.05.\\
    \midrule
    \texttt{-f/--fasta} & [FILE] & Path to FASTA file with query sequence. Required.\\password.\\
    \midrule
...
likely orthologous sequences, align them, and then use HyPhy to predict each
query codon.
