...
The model used to estimate codon conservation and predict which variants are deleterious is reported in [Chun and Fay (2009)](https://doi.org/10.1101/gr.092619.109). The actual software package is first used in [Kono *et al.* (2016)](https://doi.org/10.1093/molbev/msw102), with the [preprint](http://biorxiv.org/content/early/2016/05/12/033175) available in BioRxiv. `BAD_Mutations` has a formal publication [Kono *et al.* (2018)](https://doi.org/10.1534/g3.118.200563) with [preprint version](https://www.biorxiv.org/content/early/2017/02/27/112318). BAD_Mutations was updated when used in an examination of the fate of deleterious variants in barley genomic prediction experiment as reported by [Kono *et al.* (2019)](https://doi.org/10.1534/genetics.119.302733)
...
The configuration file is modeled after the configuration file of [STRUCTURE](http://web.stanford.edu/group/pritchardlab/structure.html) [Pritchard *et al.* (2000)](https://www.genetics.org/content/155/2/945). A sample configuration file is shown below:
