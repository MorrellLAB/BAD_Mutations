...
def main():
    ...
    if arguments_valid:
        ...
        if arguments_valid['action'] == 'setup':
            ...
            new_nuc = '/Users/tomkono/DataDisk/Dropbox/tmp/Barley_Gene_Alignments/Alignments/' + file_funcs.local_name(arguments_valid['fasta'])
            new_tree = '/Users/tomkono/DataDisk/Dropbox/tmp/Barley_Gene_Alignments/Alignments/' + file_funcs.local_name(arguments_valid['fasta'].replace('.fasta', '.tree'))
